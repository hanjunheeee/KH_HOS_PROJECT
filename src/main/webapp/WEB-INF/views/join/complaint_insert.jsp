...
<html>
	<head>
		...
		<link rel="stylesheet" href="resources/css/join/complaint_insert.css">
		
		<script src="resources/js/join/complaint_insert.js"></script>
			...
			<form method="post"
				...
				<table>
					...
					<tr class="last_tr">
						<th>첨부파일</th>
						<td>
							<input type="file" id="file" class="file_btn" name="photo" onchange="showFileName(this);"/>
				...
				<div id="btn_div">
					<input class="list_btn" type="button" value="작성글 보기"/>
